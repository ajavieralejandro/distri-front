  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-100">
        <header className="flex flex-wrap items-center justify-between gap-3 bg-indigo-900 px-5 py-4 text-white">
          <div>
            <strong>Distrisoft · Reparto</strong>
        ...
        <nav className="flex gap-2 bg-white p-3">
          <NavLink to="/operations/delivery" className="rounded px-3 py-2">
            Inicio
          </NavLink>
          <NavLink
            to="/operations/delivery/route"
