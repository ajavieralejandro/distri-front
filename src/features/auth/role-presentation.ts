...
export const DEMO_ROLE_PRESENTATIONS: DemoRolePresentation[] = [
  {
    ...
    area: 'Administración',
    shortDescription:
      'Control global, inventario, facturación demo y auditoría.',
    capabilities: [
      'Dashboard y analítica global',
      'Clientes, pedidos e inventario',
      'Facturación y auditoría demo',
    ],
    restrictions: [
      'No sustituye la autorización de la API',
  ...
  },
  {
    role: 'COMMERCE_OWNER',
    category: 'COMMERCE',
    label: 'Dueño de comercio',
    area: 'Portal comercio',
    shortDescription: 'Catálogo, cuenta, pagos y estadísticas propias.',
    capabilities: [
      'Catálogo y pedidos del comercio',
      'Cuenta corriente y pagos demo',
      'Estadísticas propias',
    ],
    restrictions: [
      'No ve datos de otros comercios',
      'No emite facturas de la distribuidora',
    ],
